"""
Задача No 5. Решение в группах
Вагоны в электричке пронумерованы натуральными числами, начиная с 1 (при этом иногда
вагоны нумеруются от «головы» поезда, а иногда – с «хвоста»; это зависит от того,
...
if i != j:
    ...
    print("Без дополнительной информации рассчитать невозможно")
